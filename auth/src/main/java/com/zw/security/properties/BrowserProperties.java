...
public class BrowserProperties {
     ...
     * '记住我'功能的有效时间，默认1小时
     */
     private final int rememberMeSeconds = 3600;
    /**
     * 社交登录，如果需要用户注册，跳转的页面
     */
     private final String signUpUrl = "/sf-signUp.html";
    /**
     * 登录响应的方式，默认是json
     */
//     private final LoginResponseType signInResponseType =LoginResponseType.JSON;
    /**
