...
import static org.springframework.aop.framework.autoproxy.DefaultAdvisorAutoProxyCreator.SEPARATOR;
...
public class ParamsCheckAop {
    ...
    enum Operator {
         ...
         * 大于
         */
        GREATER_THAN(">", ParamsCheckAop::isGreaterThan),
        /**
         * 大于等于
         */
        GREATER_THAN_EQUAL(">=", ParamsCheckAop::isGreaterThanEqual),
        /**
         * 小于
         */
        LESS_THAN("<", ParamsCheckAop::isLessThan),
        /**
         * 小于等于
         */
        LESS_THAN_EQUAL("<=", ParamsCheckAop::isLessThanEqual),
        /**
         * 不等于
         */
        NOT_EQUAL("!=", ParamsCheckAop::isNotEqual),
        /**
         * 不为空
         */
        NOT_NULL("not null", ParamsCheckAop::isNotNull);
